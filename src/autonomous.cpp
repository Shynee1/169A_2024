...
void prog() {
    ...
    pros::delay(600);
    turnPID.set_kP(2.0);
    setAngleTargetAbsolute(46);
    pros::delay(600);
    setDriveTargetUnits(-1000);
    pros::delay(1000);
    setDriveTargetUnits(375);
    pros::delay(600);
    turnPID.set_kP(turnP);
    setAngleTargetAbsolute(-55);
    pros::delay(750);
    setDriveTargetUnits(-120);  
    pros::delay(500);
    ...
    ptoMotorLeft.move(0);
    setAngleTargetAbsolute(-210);
    pros::delay(1300);
    drivePID.set_kD(4.0);
    setDriveTargetUnits(-850);
    pros::delay(1000);
    turnPID.set_kP(1.7);
    intake.move(-127);
    setAngleTargetAbsolute(-221);
    pros::delay(1000);
    drivePID.set_kD(6.0);
    setDriveTargetUnits(-2580);
    pros::delay(1800);
    drivePID.set_kD(driveD);
    setAngleTargetAbsolute(-265);
    pros::delay(750);
    verticalWings.set_value(true);
    pros::delay(100);
    ...
    pros::delay(500);
    setAngleTargetAbsolute(-315);
    pros::delay(1000);
    setDriveTargetUnits(-5000);
    pros::delay(1000);
    ...
    horizontalWings.set_value(false);
    pros::delay(100);
    setDriveTargetUnits(-800);
    pros::delay(1200);
    setAngleTargetAbsolute(-110);
    pros::delay(1000);
    setDriveTargetUnits(1800);
    pros::delay(1400);
