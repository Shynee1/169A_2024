...
void prog() {
    ...
    pros::delay(2100);
    setAngleTargetAbsolute(-92);
    pros::delay(700);
    horizontalWings.set_value(true);
    pros::delay(100);
    setDriveTargetUnits(750);
    pros::delay(1000);
    horizontalWings.set_value(false);
    pros::delay(100);
    setAngleTargetAbsolute(-240);
    pros::delay(900);
    setDriveTargetUnits(-500);
    pros::delay(800);
    setAngleTargetAbsolute(-320);
    pros::delay(1000);
